 ...
 */
public final class IntegerProcessingAckingTopology {

  private static final Logger LOG = Logger.getLogger(IntegerProcessingAckingTopology.class.getName());

  private IntegerProcessingAckingTopology() {
  }
